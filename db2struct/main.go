...
var structType = goopt.String([]string{"-H", "--struct-type"}, "", "Model DTO")
...
func main() {
	...
	struc, err := db2struct.Generate(*columnDataTypes, *mariadbTable, *structName, *packageName, *jsonAnnotation, *gormAnnotation, *gureguTypes, *structType)
